...
service = new tripadvisor1.p.rapidapi.com;
service.findPlaceFromQuery(request, function(results, status) {
  if (status === tripadvisor1.p.rapidapi.com.OK) {
  ...
  service.nearbySearch(
    { location: latLon, radius: 5000, type: ["restaurants"] },
